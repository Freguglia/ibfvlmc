...
// ibf
List ibf(List z_test, IntegerVector z_train, IntegerVector renewal, double alpha, double logprior_penalty, unsigned int Hmax, unsigned int alphlen, unsigned int burnin, unsigned int nsamples);
