...
// ibf
void ibf(IntegerVector z_test, List z_train, IntegerVector renewal, double alpha, unsigned int Hmax, unsigned int alphlen, unsigned int burnin);
RcppExport SEXP _ibfvlmc_ibf(SEXP z_testSEXP, SEXP z_trainSEXP, SEXP renewalSEXP, SEXP alphaSEXP, SEXP HmaxSEXP, SEXP alphlenSEXP, SEXP burninSEXP) {
BEGIN_RCPP
    ...
    ibf(z_test, z_train, renewal, alpha, Hmax, alphlen, burnin);
    return R_NilValue;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_ibfvlmc_ibf", (DL_FUNC) &_ibfvlmc_ibf, 7},
    {NULL, NULL, 0}
};
